...
public class ApiAuthenticationEntrypointTest {
  ...
  private ApiAuthenticationEntrypoint apiAuthenticationEntrypoint = new ApiAuthenticationEntrypoint();

  @Nested
  @DisplayName("Agent.commence")
  ...
  class Commence {
    ...
    private AuthenticationException authExceptionMock = Mockito.mock(AuthenticationException.class);
